...
if (isset($_GET['busca'])) {
  $pesquisa = '%' . $_GET['busca'] . '%';
  $mysql_query = "SELECT * FROM Cliente WHERE Nome LIKE :pesquisa ORDER BY Nome";
    ...
    <div class="col-md-11">
      <form action="" method="get" class="mb-2">
        <div class="input-group">
          <input type="text" class="form-control" placeholder="Buscar Cliente" name="busca" required>
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
      ...
      if ($stmt->rowCount() == 0) {
        ?>
        <tr>
          <td colspan="6">Nenhum Cliente encontrado com esse nome...</td>
        </tr>
        <?php
      } else {
          ...
          <tr>
            ...
            <td style="text-align:center">
              <a href="cliente-update.php?id=<?php echo $data['IdCliente']; ?>">
                <button type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
                    viewBox="0 0 512 512">
                    <style>
                      svg {
                        fill: #ffffff
              ...
              <a href="cliente-registro.php?id=<?php echo $data['IdCliente']; ?>">
