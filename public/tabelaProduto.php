...
<body>
    ...
    <div class="container">
        ...
        <div class="float-right p-1">
            <a href="contato-insert.php"><button type="button" class="btn btn-success">Novo Produto</button></a>
        </div>
                    ...
                    while ($data = $sql_query->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a
                                    href="contato-update.php?id=<?php echo $data['IdProduto']; ?>&nome= <?php echo $data['Nome'] ?>">
                                ...
                                <a href="contato-delete.php?id=<?php echo $data['IdProduto']; ?>">
