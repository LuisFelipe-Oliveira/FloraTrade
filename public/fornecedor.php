...
if (isset($_GET['busca'])) {
  $row = "";
  $pesquisa = '%' . $_GET['busca'] . '%';
  $sql_code = "SELECT * FROM fornecedor WHERE NomeFornecedor LIKE :pesquisa ORDER BY IdFornecedor";
  ...
  $row = "";
  $sql_code = "SELECT * FROM fornecedor ORDER BY IdFornecedor";
            ...
            <div class="col-md-11">
                <form action="" method="get" class="mb-2">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Buscar fornecedor" name="busca" required>
