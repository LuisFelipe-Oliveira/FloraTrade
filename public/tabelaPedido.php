...
if (isset($_GET['busca'])) {
    $row = "";
    $pesquisa = '%' . $_GET['busca'] . '%';
    $sql_code = "SELECT * FROM pedido WHERE IdPedido LIKE :pesquisa ORDER BY IdPedido";
    ...
    $row = "";
    $sql_code = "SELECT * FROM pedido ORDER BY IdPedido";
...
<body>
    ...
    <div class="container">
            ...
            <div class="col-md-11">
                <form action="" method="get" class="mb-2">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Buscar pedidos" name="busca" required>
        ...
        <div class="float-right p-1">
            <a href="tabelaPedido-insert.php"><button type="button" class="btn btn-success">Novo Pedido</button></a>
        </div>
                    ...
                    foreach ($sql_query as $data) { ?>
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a
                                    href="tabelaPedido-update.php?id=<?php echo $data['IdPedido']; ?>">
                                ...
                                <a href="tabelaPedido-delete.php?id=<?php echo $data['IdPedido']; ?>">
                                ...
                                <a href="tabelaPedido-registro.php?id=<?php echo $data['IdPedido']; ?>">
